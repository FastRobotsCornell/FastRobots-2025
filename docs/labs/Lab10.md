...
In the odometry motion model, any control input `u` can be expressed as a tuple <span><img src="=https://latex.codecogs.com/svg.latex?u \equiv [rot1, trans, rot2]"></span>
